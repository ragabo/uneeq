  ...
  return (
    <Button
      ...
      sx={{
        ...
        animation: recording
          ? fourTwo(`${pulse('rgb(223,45,70,0.6)')} 1.2s infinite`, `none`)
          : sending
          ? `${bganimationOneSide} 2s ease-in-out forwards infinite`
          : 'none',
        transition: recording ? '0.2s' : 'all 1s',
        borderColor: '#e63f37',
        boxShadow: '0px 4px 30px rgb(223,45,70,0.6)',
        '&:focus': {
          borderColor: '#e63f37',
          boxShadow: recording
            ? fourTwo(`0px 0px 0px 11px rgb(223,45,70,0.6)`, 'none')
            : 'none'
        },
        px: [0, 0, 0, 0, 30, 30],
        width: [47, 47, 70, 70, 'auto', 'auto'],
