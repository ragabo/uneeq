...
import { ReactComponent as BankLogo } from '../../assets/img/bank_albilad.svg'
    ...
    <Flex sx={styles.bar}>
      ...
      >
        ...
        onScreenInfo?.nextSuggestedResponses?.suggestedResponses?.length > 0 ? (
          ...
          >
            <SkipIcon />
            <span>{t('BottomBar.BottomBar.ShowNextSteps')}</span>
          </Button>
        ) : (
          <Flex style={{ position: 'relative' }} sx={styles.pttOuterContainer}>
            {speechMode && (
              <Flex sx={styles.pttContainer}>
                ...
                {/*   <Flex sx={styles.desktopBankLogo}>
                  <BankLogo />
              </Flex>*/}
